...
class Ui_PSBuilder(object):
    def setupUi(self, PSBuilder):
        ...
        self.verticalLayout.addWidget(self.pushDogmin)
    ...
    def retranslateUi(self, PSBuilder):
        ...
        self.pushDogmin.setText(_translate("PSBuilder", "Dogmin"))
        ...
        self.label_3.setText(_translate("PSBuilder", "Label fontisize"))
