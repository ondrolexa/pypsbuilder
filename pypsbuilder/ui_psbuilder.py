...
class Ui_PSBuilder(object):
    def setupUi(self, PSBuilder):
        ...
        self.checkPartial = QtWidgets.QCheckBox(self.groupBox_2)
        self.checkPartial.setObjectName("checkPartial")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.checkPartial)
    ...
    def retranslateUi(self, PSBuilder):
        ...
        self.checkPartial.setText(_translate("PSBuilder", "Export partial areas to drawpd"))
