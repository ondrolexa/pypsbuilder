...
class Ui_PSBuilder(object):
    def setupUi(self, PSBuilder):
        ...
        self.checkAreas = QtWidgets.QCheckBox(self.groupBox_2)
        self.checkAreas.setObjectName("checkAreas")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.SpanningRole, self.checkAreas)
        ...
        self.pushInvZoom = QtWidgets.QPushButton(self.groupBox_6)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushInvZoom.sizePolicy().hasHeightForWidth())
        self.pushInvZoom.setSizePolicy(sizePolicy)
        self.pushInvZoom.setObjectName("pushInvZoom")
        self.horizontalLayout_3.addWidget(self.pushInvZoom)
        ...
        PSBuilder.setTabOrder(self.pushInvRemove, self.pushInvZoom)
    ...
    def retranslateUi(self, PSBuilder):
        ...
        self.checkAreas.setText(_translate("PSBuilder", "Export areas to drawpd"))
        ...
        self.pushInvZoom.setText(_translate("PSBuilder", "Zoom"))
