...
class Ui_PSBuilder(object):
    def setupUi(self, PSBuilder):
        ...
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.LabelRole, self.checkAutoconnect)
    ...
    def retranslateUi(self, PSBuilder):
        ...
        self.checkAutoconnect.setText(_translate("PSBuilder", "Automatically connect univariant lines if possible"))
