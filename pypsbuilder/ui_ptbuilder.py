...
class Ui_PTBuilder(object):
    ...
    def retranslateUi(self, PTBuilder):
        ...
        self.checkLabelInvText.setText(_translate("PTBuilder", "Show zero phases with numbers"))
        self.checkLabelUni.setText(_translate("PTBuilder", "Label univariant lines"))
        self.checkLabelUniText.setText(_translate("PTBuilder", "Show zero phase with numbers"))
