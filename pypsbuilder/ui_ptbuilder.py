...
class Ui_PTBuilder(object):
    def setupUi(self, PTBuilder):
        ...
        self.formLayout.setWidget(
            4, QtWidgets.QFormLayout.LabelRole, self.checkLabelInv
        )
        ...
        self.formLayout.setWidget(
            4, QtWidgets.QFormLayout.FieldRole, self.checkLabelInvText
        )
        ...
        self.formLayout.setWidget(
            5, QtWidgets.QFormLayout.LabelRole, self.checkLabelUni
        )
    ...
    def retranslateUi(self, PTBuilder):
        ...
        self.groupBox.setTitle(
            _translate("PTBuilder", "Default PT range for calculations")
        )
        ...
        self.label_4.setText(
            _translate("PTBuilder", "Extend view range to calculation range [%]")
        )
        ...
        self.checkLabelInvText.setText(
            _translate("PTBuilder", "Show zero phases with or without numbers")
        )
        self.checkLabelUni.setText(_translate("PTBuilder", "Label univariant lines"))
        self.checkLabelUniText.setText(
            _translate("PTBuilder", "Show zero phase with or without numbers")
        )
        self.checkLabelDog.setText(_translate("PTBuilder", "Label dogmins"))
        self.checkLabelDogText.setText(
            _translate("PTBuilder", "Show phases instead numbers")
        )
        self.label_2.setText(_translate("PTBuilder", "Labels alpha"))
        self.checkAutoconnectUni.setText(
            _translate(
                "PTBuilder", "Automatically connect new univariant lines if possible"
            )
        )
        self.checkAutoconnectInv.setText(
            _translate(
                "PTBuilder", "Automatically connect new invariant points if possible"
            )
        )
        self.checkUseInvGuess.setText(
            _translate("PTBuilder", "Use ptguess from connected invariant point")
        )
        self.checkHidedoneUni.setText(
            _translate("PTBuilder", "Hide labels of fully connected lines")
        )
        self.checkOverwrite.setText(
            _translate(
                "PTBuilder", "Do not overwrite already calculated lines and points"
            )
        )
        self.checkHidedoneInv.setText(
            _translate("PTBuilder", "Hide labels of fully connected points")
        )
        self.label_3.setText(_translate("PTBuilder", "Label fontsize"))
        self.pushApplySettings.setText(_translate("PTBuilder", "Apply"))
        self.tabMain.setTabText(
            self.tabMain.indexOf(self.tabSettings), _translate("PTBuilder", "Settings")
        )
        self.pushReadScript.setText(_translate("PTBuilder", "Reset"))
        self.pushSaveScript.setText(_translate("PTBuilder", "Save"))
        self.tabMain.setTabText(
            self.tabMain.indexOf(self.tabScript), _translate("PTBuilder", "Script file")
        )
        self.pushGuessDogmin.setText(_translate("PTBuilder", "Set ptguess"))
        self.pushDogminRemove.setText(_translate("PTBuilder", "Remove"))
        self.tabMain.setTabText(
            self.tabMain.indexOf(self.tabDogmin), _translate("PTBuilder", "Dogmin")
        )
        self.tabMain.setTabText(
            self.tabMain.indexOf(self.tabLog), _translate("PTBuilder", "Log")
        )
        self.tabOutput.setTabText(
            self.tabOutput.indexOf(self.tabModes), _translate("PTBuilder", "Modes")
        )
        self.tabOutput.setTabText(
            self.tabOutput.indexOf(self.tabFull), _translate("PTBuilder", "Full output")
        )
        ...
        self.actionImport_project.setText(
            _translate("PTBuilder", "&Import into range...")
        )
        self.actionImport_from_old.setText(
            _translate("PTBuilder", "Import from old...")
        )
        self.actionImport_drfile.setText(
            _translate("PTBuilder", "Import from drfile...")
        )
        ...
        self.actionParse_working_directory.setText(
            _translate("PTBuilder", "Parse working directory")
        )
