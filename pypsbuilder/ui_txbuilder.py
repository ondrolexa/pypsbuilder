...
class Ui_TXBuilder(object):
    def setupUi(self, TXBuilder):
        ...
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.checkHidedone)
    ...
    def retranslateUi(self, TXBuilder):
        ...
        self.checkLabelInvText.setText(_translate("TXBuilder", "Show zero phases with numbers"))
        self.checkLabelUni.setText(_translate("TXBuilder", "Label univariant lines"))
        self.checkLabelUniText.setText(_translate("TXBuilder", "Show zero phase with numbers"))
        self.label_2.setText(_translate("TXBuilder", "Labels alpha"))
        self.label_3.setText(_translate("TXBuilder", "Label fontsize"))
        self.checkHidedone.setText(_translate("TXBuilder", "Hide labels of fully connected lines and points"))
